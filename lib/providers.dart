...
final categoryListProvider = StateNotifierProvider<CategoryList, Map<Category, bool>>((_) => createCategoryList([
...
final selectedCategories = Provider<List<Category>>((ref) => ref
